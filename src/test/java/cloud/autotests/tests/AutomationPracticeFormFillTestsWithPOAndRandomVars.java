...
public class AutomationPracticeFormFillTestsWithPOAndRandomVars extends TestBase {

    //Test data variables
    String firstName = getRandomString(10),//"Anton",
           lastName = getRandomString(10),//"Gorodetskiy",
           userEmail = getRandomEmail(),//"Anton.Gorodetskiy@mail.com",
            gender = "Male",
            ...
            currentAddress = getRandomString(10),//"Karnal Bus Stand",
            state = "Haryana",
            city = "Karnal";
